...
public class MainMenu implements Screen {
    ...
    public void render(float delta) {
        ...
        game.font.draw(game.batch, "as possible after its first check.", 25, 385); game.font.draw(game.batch, "The Attacker has a maximum of 10 moves to do its first Check, else the Defender gains the maximum of 50 points.", 25, 400);
